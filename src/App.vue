...
<template>
  <div class="containerH">
    ...
    <div class="bg-violet-300" style="width: 100vw; height: 100vh" id="galerie">
      <div class="wrapper2">
        <div>One</div>
        <div>Two</div>
        <div>Three</div>
...
.item {
  ...
  flex: none; /* Prevent flexbox from stretching the items */
  width: 100vw; /* Example width, can be adjusted */
